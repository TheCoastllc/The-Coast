    ...
    <main className="min-h-screen bg-[#0A0C12] text-white">
      ...
      <header className="border-b border-white/6">
        <div className="max-w-5xl mx-auto flex items-center justify-between h-14 px-5">
          ...
          <a
            ...
            className="text-xs text-[#E6B24D] hover:text-[#E6B24D]/80 transition-colors font-medium tracking-wide"
          >
            Free Brand Audit
          </a>
        </div>
      ...
      <section className="pt-24 pb-16 px-5">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-[#E6B24D] text-xs tracking-[0.3em] uppercase font-light mb-6">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {tools.map((tool) => (
            <Link
              ...
              className="group block relative border border-white/6 bg-white/2 hover:bg-white/4 hover:border-[#E6B24D]/20 transition-all duration-300 p-6 md:p-8"
            >
              <div className="flex items-start gap-6">
                {/* Number */}
                <span className="text-[#E6B24D]/30 font-light text-4xl md:text-5xl tabular-nums leading-none mt-1 hidden md:block">
                  {tool.number}
                </span>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <h2 className="text-xl md:text-2xl font-semibold tracking-tight group-hover:text-[#E6B24D] transition-colors">
                      {tool.title}
                    </h2>
                    <span className="text-[10px] tracking-wider uppercase bg-[#E6B24D]/10 text-[#E6B24D] px-2.5 py-0.5 rounded-sm">
                      {tool.badge}
                    </span>
                  </div>
                ...
                {/* Arrow */}
                <div className="shrink-0 w-10 h-10 border border-white/8 flex items-center justify-center group-hover:border-[#E6B24D]/30 group-hover:bg-[#E6B24D]/5 transition-all duration-300 mt-1">
                  <ArrowRight className="w-4 h-4 text-white/20 group-hover:text-[#E6B24D] group-hover:translate-x-0.5 transition-all duration-300" />
                </div>
              </div>

              {/* Left accent bar on hover */}
              <div className="absolute left-0 top-0 h-full w-[2px] bg-[#E6B24D] origin-top scale-y-0 group-hover:scale-y-100 transition-transform duration-300" />
            </Link>
          ))}
        </div>
      </section>
