...
export const metadata: Metadata = {
  ...
  description:
    'Measure your Wave Rating with Coast Brand Index, then run three free diagnostics: the brand quiz, the consistency checklist, and the 3-second test.',
  alternates: { canonical: 'https://coastglobal.org/offers' },
  twitter: buildTwitter({
    title: 'The Brand Lab - Free Brand Diagnostics | The Coast Global',
    description:
      'Measure your Wave Rating with Coast Brand Index and run three free tools to diagnose your brand strength, consistency, and first impressions.',
  }),
  openGraph: {
    type: 'website',
    title: 'The Brand Lab - Free Brand Diagnostics | The Coast Global',
...
const offersSchema = {
  ...
  '@type': 'ItemList',
  name: 'The Coast Global - Free Brand Tools',
  url: 'https://coastglobal.org/offers',
  itemListElement: [
    { '@type': 'ListItem', position: 1, item: { '@type': 'WebApplication', name: 'Coast Brand Index', url: 'https://coastglobal.org/cbi', applicationCategory: 'BusinessApplication', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } },
