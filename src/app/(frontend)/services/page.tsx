...
const servicesSchema = {
  ...
  numberOfItems: 11,
  itemListElement: [
    { '@type': 'ListItem', position: 1, item: { '@type': 'Service', name: 'Logo Design', description: 'Custom logo with 3 concepts & 2 revision rounds', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 2, item: { '@type': 'Service', name: 'Full Rebrand', description: 'Complete brand transformation package', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 3, item: { '@type': 'Service', name: 'Brand Identity Guidelines', description: 'Logo, colors, typography & usage rules', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 4, item: { '@type': 'Service', name: 'Flyers', description: 'Print-ready promotional designs (digital + print)', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 5, item: { '@type': 'Service', name: 'EPK / Press Kit', description: 'Professional media kit for press & partners', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 6, item: { '@type': 'Service', name: 'Social Graphics', description: '5-10 branded templates for social platforms', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 7, item: { '@type': 'Service', name: 'Pitch Deck', description: 'Investor-ready presentation design', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 8, item: { '@type': 'Service', name: 'Website Design', description: 'Custom website design & development', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 9, item: { '@type': 'Service', name: 'Video & Motion', description: 'Promotional videos & animations', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 10, item: { '@type': 'Service', name: 'Digital Marketing', description: 'SEO, ads setup, email campaigns', provider: { '@id': 'https://coastglobal.org/#organization' } } },
    { '@type': 'ListItem', position: 11, item: { '@type': 'Service', name: 'Social Media Management', description: 'Content creation, scheduling & management', provider: { '@id': 'https://coastglobal.org/#organization' } } },
  ],
}
