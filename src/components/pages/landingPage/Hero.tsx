                ...
                <div className="relative z-10">
                    <h1 className='text-balance leading-none uppercase'>
                        <div className='flex items-center gap-2'>
                            ...
                            <TextAnimate className=' hero-large-text font-light'>
                                We Turn
                            </TextAnimate>
                        </div>

                        <div className='flex items-center'>
                            <TextAnimate className='max-w-2xs hidden md:block text-justify'>
                        ...
                        <TextAnimate className='empire font-semibold'>
                            Empires
                        </TextAnimate>
                    </h1>
