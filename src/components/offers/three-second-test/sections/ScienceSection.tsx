export function ScienceSection() {
  return (
    <section className="min-h-screen bg-[#f8fafb] flex flex-col justify-center px-6 md:px-16 py-20">
      <div className="max-w-[760px] mx-auto w-full">
        <span className="text-[#C9A24B] text-[11px] font-bold tracking-[0.2em] uppercase mb-6 block">
          The Research
        </span>
        <h2 className="text-2xl md:text-4xl font-bold text-[#0D2337] leading-tight tracking-tight mb-8">
          Your brand gets three seconds.
          <br />
          Here&apos;s what happens in them.
        </h2>

        <div className="space-y-5 text-[#3A5268] text-[15px] leading-[1.72] mb-8">
          <p>
        ...
        <blockquote className="border-l-2 border-[#C9A24B] pl-6 my-10">
          <p className="text-[#0D2337] text-lg md:text-xl font-medium italic leading-relaxed">
            &ldquo;Customers don&apos;t evaluate your brand. They react to it.&rdquo;
          </p>
        </blockquote>

        {/* Stat callout */}
        <div className="flex flex-col sm:flex-row items-center gap-6 bg-white border border-[#DDE8EF] rounded-sm p-6 md:p-8">
          <div className="text-center sm:text-left shrink-0">
            <span className="text-3xl md:text-4xl font-bold text-[#0D2337] block">50ms</span>
            <span className="text-[#7A94AA] text-xs tracking-wider uppercase">First impression</span>
          </div>
          <div className="w-px h-12 bg-[#DDE8EF] hidden sm:block" />
