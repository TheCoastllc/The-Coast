...
export function CoverSection() {
  return (
    <section className="min-h-screen bg-[#0A0C12] relative overflow-hidden flex flex-col justify-between px-6 md:px-16 py-12">
      {/* Decorative circles */}
      <div className="absolute -bottom-32 -right-20 w-[520px] h-[520px] rounded-full border border-[#E6B24D]/[0.08] pointer-events-none" />
      ...
      <div className="max-w-[760px] mx-auto w-full flex-1 flex flex-col justify-center py-16">
        <span className="text-[#E6B24D] text-[11px] font-semibold tracking-[0.18em] uppercase mb-7">
          Brand Intelligence
        </span>
        ...
        <div className="w-10 h-px bg-[#E6B24D]/60 mb-7" />
